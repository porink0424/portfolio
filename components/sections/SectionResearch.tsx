...
const data = {
  ...
  EN: {
    text: [
      ...
      'I am researching the "Emergent Language" field,',
      "where I analyze the language artificially generated by having agents composed of neural networks talk to each other.",
      "I plan to use an agent that mimics the structure of the human brain",
